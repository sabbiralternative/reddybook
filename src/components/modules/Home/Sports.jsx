const Sports = () => {
  return (
    <section className="bet-details-sec">
      ...
      <div>
        <div className="bets-details-page">
          <div className="row">
            <div className="col-12 col-sm-12 col-md-6 col-lg-6">
              <div className="game-left-box">
                <div className="game-left-col">
                  <a href="javascript:void(0);" style={{ paddingLeft: "2px" }}>
                    🎮
                  </a>
                  <div className="game-box">
                    <a href="javascript:void(0);">
                      <p>Islamabad United Srl vs. Quetta Gladiators Srl</p>
                      <p className="team-event-name">(Exclusive League)</p>
                    </a>
                  </div>
            ...
            <div className="col-12 col-sm-12 col-md-6 col-lg-6">
              <div className="game-left-box">
                <div className="game-left-col">
                  ...
                  <div className="game-box">
                    <a href="javascript:void(0);">
                      <p>Trent Rockets W v Birmingham Phoenix W</p>
                      <p className="team-event-name">(The Hundred - Womens)</p>
                    </a>
                  </div>
                  <div className="game-date-inplay-box">
                    <span>Live</span>
            ...
            <div className="col-12 col-sm-12 col-md-6 col-lg-6">
              <div className="game-left-box">
                <div className="game-left-col">
                  ...
                  <div className="game-box">
                    <a href="javascript:void(0);">
                      <p>Trent Rockets v Birmingham Phoenix</p>
                      <p className="team-event-name">(The Hundred)</p>
                    </a>
                  </div>
                  <div className="game-date-inplay-box">
                    <span>Live</span>
